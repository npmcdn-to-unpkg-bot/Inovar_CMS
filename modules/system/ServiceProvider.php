...
class ServiceProvider extends ModuleServiceProvider
{
    ...
    protected function registerConsole()
    {
        ...
        $this->registerConsoleCommand('theme.create', 'System\Console\ThemeCreate');
        ...
        //$this->registerConsoleCommand('theme.partial', 'System\Console\ThemePartial');

        $this->registerConsoleCommand('page.create', 'System\Console\PageCreate');
        //$this->registerConsoleCommand('page.partial', 'System\Console\PagePartial');
    }
